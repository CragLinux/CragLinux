...
| <a id="ad-027"></a>AD-027 | cports fork (supersedes AD-001) | Crag maintains a **fork** of cports (`CragLinux/cports`, branch `astro`; repo location ~~`aka-mj/astro-cports`~~ superseded by [AD-029](#ad-029)), Harbormaster-pinned; Crag changes are ordinary in-fork commits, not an overlay collection; a scheduled update-report tracks currency | Accepted | [03](03-build-system.md) |
...
| <a id="ad-029"></a>AD-029 | cports fork repo move | The cports fork moved `aka-mj/astro-cports` → **`CragLinux/cports`** (all branches mirrored verbatim; branch `astro`, the pin, and the AD-027 fork model unchanged); Harbormaster manifest/lock URLs and CI clone URLs repointed | Accepted | [03](03-build-system.md) |
